...
xdg_desktop_dir = (get_xdg_desktop_dir)
xdg_documents_dir = (get_xdg_documents_dir)
xdg_download_dir = (get_xdg_download_dir)
xdg_music_dir = (get_xdg_music_dir)
xdg_pictures_dir = (get_xdg_pictures_dir)
xdg_prefix_home = (get_xdg_prefix_home)
xdg_publicshare_dir = (get_xdg_publicshare_dir)
xdg_runtime_dir = (get_xdg_runtime_dir)
xdg_templates_dir = (get_xdg_templates_dir)
xdg_videos_dir = (get_xdg_videos_dir)
